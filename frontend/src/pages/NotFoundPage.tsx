  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <h1 className="text-xl font-semibold text-white mb-2">页面未找到</h1>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            to="/history"
            className="px-6 py-2.5 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-lg text-sm text-gray-300 transition-colors"
          >
            查看历史
          </Link>
        </div>
