  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2 px-1">
        ...
        <h3 className="text-sm font-semibold text-gray-900">方案设计</h3>
          ...
          return (
            ...
            >
              ...
              <div className="text-xs text-gray-600 leading-relaxed prose prose-xs max-w-none
                             prose-headings:text-gray-700 prose-headings:text-xs prose-headings:font-semibold prose-headings:mt-2 prose-headings:mb-1
      ...
      {/* Auto-select note */}
      <div className="flex items-center gap-2 px-1 py-2 rounded bg-gray-50">
