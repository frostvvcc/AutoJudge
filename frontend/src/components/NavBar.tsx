...
export default function NavBar() {
  ...
  return (
    <header className="border-b border-gray-800 px-4 sm:px-6 py-3 sm:py-4 relative">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <Link to="/dashboard" className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <h1 className="text-lg sm:text-xl font-bold text-white">AutoJudge</h1>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-500/30 to-purple-500/30 border border-gray-700 flex items-center justify-center text-xs text-white font-medium">
      ...
      {mobileOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900 border-b border-gray-800 z-50">
          <div className="px-4 py-3 border-b border-gray-800 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500/30 to-purple-500/30 border border-gray-700 flex items-center justify-center text-sm text-white font-medium">
              {user?.username?.[0]?.toUpperCase()}
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 py-2">
            <button
              onClick={handleLogout}
              className="w-full text-left px-4 py-3 text-sm text-red-400 hover:bg-gray-800/50 transition-colors"
            >
              退出登录
            </button>
          </div>
